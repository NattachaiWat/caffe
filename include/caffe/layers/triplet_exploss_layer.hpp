...
class TripletExpLossLayer: public Layer<Dtype> {
    public:
        explicit TripletExpLossLayer(const LayerParameter& param)
            : Layer<Dtype>(param) {}
        ...
        virtual inline const char* type() const { return "TripletExpLoss"; }
