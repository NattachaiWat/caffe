...
class OnlinePairLossLayer : public LossLayer<Dtype> {
 public:
  explicit OnlinePairLossLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline int ExactNumBottomBlobs() const { return 2; }
  virtual inline const char* type() const { return "OnlinePairLoss"; }
  /**
...
#endif  // CAFFE_ONLINEPAIR_LOSS_LAYER_HPP_
